...
const LanguageField = ({ auth, pagedata = {} , toastData}) => {
    const {
        data,
        setData,
        processing,
        ...
        post,
        patch,
    } = useForm({"name":null,"short_code":null,"create_another":false});
                ...
                <div className="flex justify-between">
                    <div className="flex-none w-50">
                        <h2 className="font-semibold text-xl py-5 text-gray-800 leading-tight">
                           {pagedata.id ? ("Edit ID#" + pagedata.id) : "Create Language" }
                        </h2>
                    </div>
                </div>
 ...
 <div className="mt-4">
    <InputLabel forInput="short_code" value="Short Code" />
